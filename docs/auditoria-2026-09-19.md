...
| Alto | (repo) | Sin tests ni CI: no existen `tests/` ni `.github/`. En un proyecto con credenciales de terceros y datos de salud, cualquier regresión llega a producción sin red. | **Resuelto** en `2026-09-19`: 22 tests sobre los invariantes que ya han fallado, más workflow de CI con `mypy` y `pytest`. |
